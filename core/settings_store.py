...
The dashboard's Save & Apply calls save() -> every registered listener
(brain, voice_manager, ...) re-resolves its active provider. No restart needed.
Secrets are NOT stored here — they live in .env (see config.set_api_key).
"""
...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "tts": {
        # "auto" = use `preferred` if its key is configured, else edge_tts, else pyttsx3.
        "active": "auto",
    ...
    "stt": {
        "active": "google",          # proven free default; whisper fully built & selectable
