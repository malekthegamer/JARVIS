...
Day-to-day settings live in data/settings.json (managed by core.settings_store
and the dashboard settings page). This module only holds filesystem paths and
...
def set_api_key(provider: str, value: str) -> bool:
    ...
    Called by the settings API when the user enters a key in the dashboard.
